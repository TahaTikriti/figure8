...
export const imageOptions = [
  ...
  {
    id: 16,
    name: "Blue Tech Wave Background",
    url: "/blue-background.jpeg", // Use the correct relative path from public/
    alt: "Blue Technology Wave Dots Background",
    position: "object-center",
  },
];
...
export default function HeroBackground({
  ...
  const selectedImage =
    imageOptions.find((opt) => opt.id === currentOption) || imageOptions[0];
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-white">
      ...
      >
        ...
        />
        {/* No overlay for blue background image (id: 16) */}
        {selectedImage.id !== 16 && (
